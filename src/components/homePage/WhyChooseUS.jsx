...
const WhyChooseUs = () => {
  ...
  return (
    <div className="flex-col bg-[#FDFBFF] py-[5.938rem]">
      ...
      <div className=" max-w-[90rem] px-[1.25rem] flex flex-row w-full gap-[1.5rem] py-[2.188rem] mx-auto">
        {features.map((feature, index) => (
          <div
            key={index}
            className="w-1/3 h-[auto] p-[2rem] rounded-2xl border border-[#E1D9E9] hover:border-primary transition duration-300 flex flex-col gap-[1rem]"
          >
